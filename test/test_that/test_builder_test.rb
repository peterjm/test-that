...
module TestThat
  class TestBuilderTest < Minitest::Test
    ...
    def test_walks_up_to_find_python_harness
      in_tmpdir do
        system("git", "init", "-q") || raise("git init failed")
    ...
    def test_default_directory_from_config_file_is_honored
      in_tmpdir do
